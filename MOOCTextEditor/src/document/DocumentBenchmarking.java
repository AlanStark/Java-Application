...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			// Record BasicDocument
			long startTime = System.nanoTime();
			for (int i = 0; i < trials; i++){
				Document doc = new BasicDocument(inputString);
				doc.getFleschScore();
			}
			long elapsedTime = System.nanoTime() - startTime;
			System.out.print(elapsedTime/Math.pow(10,9) + "\t");

			// Record EfficientDocument
			startTime = System.nanoTime();
			for (int i = 0; i < trials; i++){
				Document doc = new EfficientDocument(inputString);
				doc.getFleschScore();
			}
